...
namespace EyesOfTheDragon.XRpgLibrary.ItemClasses
{
    public class Armor : BaseItem
    {
        ...
        public Armor(string armorName, string armorType, int price, float weight, ArmorLocation location, int defenseValue, int defenseModifier, params string[] allowableClasses)
